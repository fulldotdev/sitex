...
extend the SiteX TypeScript config, add the scripts, and create the first route.`}
      ...
      <p>
        Install the SiteX package together with React, Vite+, and the Vite
        packages your app needs.
      </p>
      <CodeBlock
        lang="bash"
        code={`pnpm add @fulldotdev/sitex react react-dom vite vite-plus @vitejs/plugin-react
...
export default defineConfig({
  ...
  "compilerOptions": {
    "paths": {
      ...
      <p>
        SiteX runs through Vite+. Use the Vite+ commands for development,
  ...
  "scripts": {
    ...
    "check": "vp check"
      ...
      <p>
        <code>vp dev</code> starts the development server and lets SiteX render
        routes from <code>src/pages</code> on request.
      </p>
      <p>
