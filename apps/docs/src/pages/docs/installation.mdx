...
order: 2
tocItems:
  - href: "#ai-agent-install"
    label: "AI agent install"
  - href: "#manual-install"
...
/>
      ...
      <p>
        Create <code>src/pages/index.tsx</code> for a TSX route, or create an
        MDX page with frontmatter and a matching layout in{" "}
        <code>src/layouts</code>. Page files in <code>src/pages</code> become
        static routes.
      </p>
      <CodeBlock
        lang="tsx"
